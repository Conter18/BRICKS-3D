...
class raqueta(ExtendedBaseModel):
    def __init__(self, app, vao_name='raqueta', tex_id='raqueta',
                 pos=(0, 0, 0), rot=(0, 0, 0), scale=(0.5, 0.5, 0.5)):
        super().__init__(app, vao_name, tex_id, pos, rot, scale)
        self.pos = list(pos)  # Convertir pos en una lista
